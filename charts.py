...
class ChartGenerator:
    ...
    def __new__(cls):
        if cls._instance is None:
            cls._instance = super(ChartGenerator, cls).__new__(cls)
    ...
    def generate_feed_volume_chart(self, kpis: List, output_dir: str) -> str:
    ...
    def generate_diaper_chart(self, kpis: List, output_dir: str) -> str:
        self._ensure_dir(output_dir)
        dates = [kpi.date for kpi in kpis]
    ...
    def generate_temp_chart(self, kpis: List, output_dir: str) -> str:
        self._ensure_dir(output_dir)
    ...
    def generate_growth_chart(self, kpis: List, output_dir: str) -> str:
        self._ensure_dir(output_dir)
    ...
    def generate_calendar_heatmap(self, kpis: List, activity_key: str, title: str, output_dir: str) -> str:
        self._ensure_dir(output_dir)
        import numpy as np
        from matplotlib.colors import LinearSegmentedColormap
        
        # Build date indexed series of activity durations
        ...
        # Construct full date range from min to max to maintain contiguous calendar matrix
        min_date, max_date = dates.min(), dates.max()
        # Add padding to start on Monday and end on Sunday
        ...
        df_cal['day_of_week'] = df_cal.index.weekday  # 0=Monday, 6=Sunday
        ...
        # Custom colormap: 0 = surface0 (grey), >0 gradient to Catppuccin Green
        ...
        ax.set_xticks([]) # Hide weeks logic for cleaner look
